...
public class Demo {
    ...
    public static void main(String[] args) {
        Book[] books = new Book[] {
                ...
                new Book(3, "Book_3",
                        new Author[] { new Author(3, "Walter",
                                "Peterson") },
                        new Publisher(1, "Publisher_1"),
                        1997, 350,
                        BigDecimal.valueOf(34.99), CoverType.HARDCOVER),
                new Book(4, "Book_4", new Author[] { new Author(4,
                        "Craig", "Gregory") },
        ...
        System.out.println(Arrays.toString(
                bookService.filterBooksByAuthor(new Author(2,
                        "William", "Wilson"), books)));

        System.out.println(Arrays.toString(
                bookService.filterBooksByPublisher(new Publisher(3,
                        "Publisher_3"), books)));

        System.out.println(Arrays.toString(
                bookService.filterBooksAfterSpecifiedYear(1992,
                        null)));

        System.out.println(Arrays.toString(
                bookService.filterBooksAfterSpecifiedYear(1993,
                        books)));
