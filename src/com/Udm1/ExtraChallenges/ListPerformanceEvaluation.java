...
public class ListPerformanceEvaluation {
    ...
    public static void addElementsToBeginning(List<Integer> list,
        ...
        counter = 0;
        while (counter < numberOfElementsToAdd) {
            list.add(0, 7);
            counter++;
        }
    }
    ...
    public static void removeElementsFromBeginning(List<Integer> list,
        ...
        if (list.size() < numberOfElementsToRemove) {
            System.out.println("Can't remove more elements than size");
            return;
        }
        counter = 0;
        while (counter < numberOfElementsToRemove) {
            list.remove(0);
            counter++;
        }
    }
